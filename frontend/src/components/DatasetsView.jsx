...
const DatasetsView = () => {
    ...
    const confirmDeleteRequest = (e, ds) => {
        e.stopPropagation();
    ...
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto animate-fade-in relative min-h-full">
                    ...
                    {filteredDatasets.map((ds) => (
                        ...
                        >
                            <div className="absolute top-0 right-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity flex gap-2">
                                <button
                                    onClick={(e) => confirmDeleteRequest(e, ds)}
                                    className="h-8 w-8 bg-white border border-slate-200 rounded-lg flex items-center justify-center text-slate-400 hover:text-rose-600 hover:border-rose-200 shadow-sm transition-all"
                                    title="Delete Dataset Registration"
                                >
                                    <Trash2 size={16} />
                                </button>
                                <div className="h-8 w-8 bg-white border border-slate-200 rounded-lg flex items-center justify-center text-slate-400 hover:text-primary-600 shadow-sm transition-all">
            ...
            {datasetToDelete && createPortal(
                <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
                    <div
                        className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm transition-opacity"
                        onClick={() => setDatasetToDelete(null)}
                    />
                    <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl relative p-6 animate-slide-up">
                        ...
                        <div className="space-y-4">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-rose-500 outline-none transition-all font-medium"
                                autoFocus
                            />
                            ...
                            <div className="flex gap-3 mt-6">
                                <button
                                    onClick={() => setDatasetToDelete(null)}
                                    className="flex-1 py-2.5 bg-slate-50 text-slate-700 font-bold text-xs uppercase tracking-widest rounded-xl hover:bg-slate-100 transition-all border border-slate-200"
                                >
                                    Cancel
                                </button>
                                <button
